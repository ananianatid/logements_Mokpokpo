...
<head>
    ...
    <title>Nos Résidences - Mokpokpo</title>
...
<body class="flex flex-col min-h-screen text-gray-800">
    ...
    <!-- Navbar -->
    <nav class="bg-white px-6 py-4 border-b border-gray-200 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <a href="{{ route('dashboard') }}"
                class="flex items-center gap-2 text-gray-800 hover:text-blue-600 transition group">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="font-bold text-xl tracking-tight text-blue-900">Mokpokpo</span>
            </div>
        </div>
    </nav>
