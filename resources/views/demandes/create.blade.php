...
@section('title', 'Demande de Logement - Mokpokpo')
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="batiment_id" value="{{ $batiment->id }}" class="sr-only" required>
                            <div
                                class="selection-card h-full p-5 rounded-xl border-2 border-gray-100 bg-gray-50 flex flex-col items-center text-center">
                                <i class="fas fa-building text-2xl mb-3 text-gray-400 group-checked:text-blue-600"></i>
